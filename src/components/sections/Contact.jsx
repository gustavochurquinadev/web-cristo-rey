    ...
    <section id="contact" ref={sectionRef} className="py-24 bg-gray-50 relative">
      <div className="container mx-auto px-6">
          ...
          <div className="contact-card bg-white p-8 rounded-2xl border border-gray-100 shadow-xl hover:shadow-2xl transition-all duration-300 group h-full">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center justify-center gap-2 text-sm text-gray-500 bg-gray-50 py-3 rounded-full">
                ...
                <span>Atención Lun a Vie: <strong>07:30 - 13:00 hs</strong></span>
              </div>
              <div className="flex items-center justify-center gap-2 text-sm text-gray-500 bg-gray-50 py-3 rounded-full">
                <Clock className="w-4 h-4 text-cristo-accent" />
                <span>Atención Lun a Vie: <strong>14:30 - 18:00 hs</strong></span>
              </div>
            </div>
          </div>
          ...
          <div className="contact-card bg-white p-8 rounded-2xl border border-gray-100 shadow-xl hover:shadow-2xl transition-all duration-300 group h-full">
            <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 uppercase tracking-wide">Contactenos</p>
              </div>
            </div>
        ...
        <div ref={mapContainerRef} className="w-full h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl border-4 border-white relative group">
          <iframe
            src="https://maps.google.com/maps?q=Av.%20Bolivia%20929%2C%20Ciudad%20Perico%2C%20Jujuy&t=&z=15&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="100%"
          ...
          <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 bg-white/95 backdrop-blur-md px-6 py-4 rounded-xl shadow-lg border border-white/50 max-w-xs pointer-events-none">
            <div className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-red-500 mt-1 flex-shrink-0 animate-bounce" />
              <div>
                <h4 className="font-bold text-cristo-primary text-sm">Colegio Católico Cristo Rey</h4>
